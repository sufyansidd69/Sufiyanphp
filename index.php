...
<body><div class="container"></div>
    ...
    <form id="" name="" method="" action="addrecord.php">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" name="OOP" id="OOP">
        </div>
        <div class="mb-3">
            <label for="DSA" class="form-label">Data Structures Algorithms</label>
            <input type="text" class="form-control" name="DSA" id="DSA">
        </div>
        <div class="mb-3">
